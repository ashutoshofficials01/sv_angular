...
@Component({
  selector: 'app-educationScore',
  standalone: false,
  templateUrl: './educationScore.html',
  styleUrls: ['./educationScore.css']
})
export class EducationScore implements OnInit {
  ...
  resUpload() {
    ...
    this.scoreService.resumeUploadEducation(formd).subscribe({
  ...
  messageUpdate(msgUpdate: resumeCalUpdate[]) {
    ...
    for (let k = 0; k < msgUpdate.length; k++) {
      if (msgUpdate[k].atsGeneralId == 121) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 122) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 123) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 124) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 125) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 126) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 127) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 128) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 129) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 130) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 131) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 132) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 133) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 134) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 135) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 136) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 137) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 138) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 139) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 140) {
