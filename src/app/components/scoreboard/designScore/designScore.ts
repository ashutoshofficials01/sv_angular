...
@Component({
  selector: 'app-designScore',
  standalone: false,
  templateUrl: './designScore.html',
  styleUrls: ['./designScore.css']
})
export class DesignScore implements OnInit {
  ...
  messageUpdate(msgUpdate: resumeCalUpdate[]) {
    ...
    for (let k = 0; k < msgUpdate.length; k++) {
      if (msgUpdate[k].atsGeneralId == 91) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 92) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 93) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 94) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 95) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 96) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 97) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 98) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 99) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 100) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 101) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 102) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 103) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 104) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 105) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 106) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 107) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 108) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 109) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 110) {
