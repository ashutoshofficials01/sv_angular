...
@Component({
  selector: 'app-financeScore',
  standalone: false,
  templateUrl: './financeScore.html',
  styleUrls: ['./financeScore.css'],
})
export class FinanceScore implements OnInit {
  role: any = String;
  ...
  resUpload() {
    ...
    this.scoreService.resumeUploadFinance(formd).subscribe({
  ...
  messageUpdate(msgUpdate: resumeCalUpdate[]) {
    for (let k = 0; k < msgUpdate.length; k++) {
      if (msgUpdate[k].atsGeneralId == 151) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 152) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 153) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 154) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 155) {
        if (msgUpdate[k].msgParamType == 'positive') {
      ...
      } else if (msgUpdate[k].atsGeneralId == 156) {
        if (msgUpdate[k].msgParamType == 'positive') {
      ...
      } else if (msgUpdate[k].atsGeneralId == 157) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 158) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 159) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 160) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 161) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 162) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 163) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 164) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 165) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 166) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 167) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 168) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 169) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 170) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
