...
@Component({
  selector: 'app-legalScore',
  standalone: false,
  templateUrl: './legalScore.html',
  styleUrls: ['./legalScore.css'],
})
export class LegalScore implements OnInit {
  role: any = String;
  ...
  resUpload() {
    ...
    this.scoreService.resumeUploadLegal(formd).subscribe({
  ...
  messageUpdate(msgUpdate: resumeCalUpdate[]) {
    for (let k = 0; k < msgUpdate.length; k++) {
      if (msgUpdate[k].atsGeneralId == 241) {
      ...
      } else if (msgUpdate[k].atsGeneralId == 242) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 243) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 244) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 245) {
        if (msgUpdate[k].msgParamType == 'positive') {
      ...
      } else if (msgUpdate[k].atsGeneralId == 246) {
        if (msgUpdate[k].msgParamType == 'positive') {
      ...
      } else if (msgUpdate[k].atsGeneralId == 247) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 248) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 249) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 250) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 251) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 252) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 253) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 254) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 255) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 256) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 257) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 258) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 259) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
      ...
      } else if (msgUpdate[k].atsGeneralId == 260) {
        if (msgUpdate[k].msgParamType == 'positive') {
          msgUpdate[k].msgDescription =
